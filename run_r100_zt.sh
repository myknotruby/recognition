...
CUDA_VISIBLE_DEVICES='0' python -u _train_parall.py --dataset=$DATASET --network "$NETWORK"  --per-batch-size 78 --lr-steps='100000,200000,300000,350000' --exclude-layer-prefix 'fc' --lr 0.01 >"$LOGFILE-$DATASET-3"
