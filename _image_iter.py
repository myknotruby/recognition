    ...
    def __init__(self, batch_size, data_shape,
        ...
        if path_imgrec:
            ...
            if header.flag>0:
              ...
              #todo: write is right, but read is wrong
              #self.header0 = (int(header.label[0])+1, int(header.label[1])-1)  #faces_ega
              self.imgidx = []
              self.id2range = {}
              self.seq_identity = range(self.header0[0], self.header0[1])
