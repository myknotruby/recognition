...
class ResidualAttentionModel_152(nn.HybridBlock):
    ...
    def __init__(self, classes=1000, **kwargs):
        ...
        with self.name_scope():
            ...
            self.residual_block1 = ResidualBlock(channels=64, in_channels=64, stride=2)
            ...
            self.residual_block5 = ResidualBlock(channels=512, in_channels=512, stride=1)
            self.residual_block6 = ResidualBlock(channels=512, in_channels=512, stride=1)
            self.residual_block7 = ResidualBlock(channels=512, in_channels=512, stride=1)
