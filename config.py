...
network.resnest = edict()
network.resnest.net_name = 'fresnest'
network.resnest.num_layers = 50

network.sphere = edict()
network.sphere.net_name = 'fspherenet'
network.sphere.num_layers = 74
...
network.mv3.emb_size = 256
network.mv3.net_output = 'GDC'
network.mv3.net_multiplier = 1.0
...
network.attse152 = edict()
network.attse152.net_name = 'fattense152'
network.attse152.emb_size = 256
#network.attse152.net_output='E'
...
dataset.emore.dataset_path = '/train/mxnet-train/datasets/faces_emore'
...
dataset.retina.dataset_path = '/train/mxnet-train/datasets/ms1m-retinaface-t1'
dataset.retina.num_classes = 93431
dataset.retina.image_shape = (112,112,3)
dataset.retina.val_targets = ['lfw']
#dataset.retina.val_targets = ['lfw', 'cfp_fp', 'agedb_30', 'ecuador_tp']

dataset.rl = edict()
dataset.rl.dataset = 'rl'
dataset.rl.dataset_path = '/train/mxnet-train/datasets/faces_rl'
dataset.rl.num_classes = 210331
dataset.rl.image_shape = (112,112,3)
dataset.rl.val_targets = ['lfw', 'cfp_fp', 'agedb_30', 'ecuador_tp']

dataset.ra = edict()
dataset.ra.dataset = 'ra'
dataset.ra.dataset_path = '/train/mxnet-train/datasets/faces_ra'
dataset.ra.num_classes = 163207
dataset.ra.image_shape = (112,112,3)
dataset.ra.val_targets = ['lfw', 'cfp_fp', 'agedb_30', 'ecuador_tp']

dataset.rlag = edict()
dataset.rlag.dataset = 'rlag'
dataset.rlag.dataset_path = '/train/mxnet-train/datasets/faces_rlag'
dataset.rlag.num_classes = 374085
dataset.rlag.image_shape = (112,112,3)
dataset.rlag.val_targets = ['lfw', 'cfp_fp', 'agedb_30', 'ecuador_tp']

dataset.lamei = edict()
dataset.lamei.dataset = 'lamei'
dataset.lamei.dataset_path = '/train/mxnet-train/datasets/faces_lamei'
dataset.lamei.num_classes = 116900
dataset.lamei.image_shape = (112,112,3)
dataset.lamei.val_targets = ['lfw', 'cfp_fp','agedb_30']

dataset.casia = edict()
dataset.casia.dataset = 'casia'
dataset.casia.dataset_path = '/train/mxnet-train/datasets/faces_casia'
dataset.casia.num_classes = 9879
dataset.casia.image_shape = (112,112,3)
dataset.casia.val_targets = ['lfw', 'cfp_fp','agedb_30', 'ecuador_tp']
