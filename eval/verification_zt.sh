...
CUDA_VISIBLE_DEVICES="1" python testimgs_verify.py --data-dir /train/mxnet-train/aligned_data --model /train/mxnet-train/face/insightface/recognition/models/r100-arcface-retina/model,21  --target 'ecu_clean' --batch-size 10
